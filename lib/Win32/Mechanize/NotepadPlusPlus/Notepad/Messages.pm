...
our %NPPMSG = (
    ...
    'NPPM_GETBOOKMARKID'                                         => ((1024 + 1000) + 111),
    ...
    'NPPM_GETCURRENTCMDLINE'                                     => ((1024 + 1000) + 109),
    ...
    'NPPM_GETCURRENTMACROSTATUS'                                 => ((1024 + 1000) + 106),  # v8.3.3
    ...
    'NPPM_GETENABLETHEMETEXTUREFUNC_DEPRECATED'                  => ((1024 + 1000) + 45),   # v8.4.x
    'NPPM_GETEXTERNALLEXERAUTOINDENTMODE'                        => ((1024 + 1000) + 103),  # v8.3.3
    ...
    'NPPM_ISAUTOINDENTON'                                        => ((1024 + 1000) + 105),  # v8.3.3
    'NPPM_ISDARKMODEENABLED'                                     => ((1024 + 1000) + 107),  # v8.4.1
    'NPPM_ISDOCSWITCHERSHOWN'                                    => ((1024 + 1000) + 86),
    'NPPM_ISDOCLISTSHOWN'                                        => ((1024 + 1000) + 86),	# v8.1.3
    ...
    'NPPM_SETEXTERNALLEXERAUTOINDENTMODE'                        => ((1024 + 1000) + 104),  # v8.3.3
...
The second group set which button is the default/activge button.
The third group affect the icon used for the dialog box.
The final group encode the return values.
...
our %NPPIDM = (
    ...
    'IDM_DOCLIST_COPYNAMES'                                      => ((40000 + 3500) + 3),		# v8.2.1
    'IDM_DOCLIST_COPYPATHS'                                      => ((40000 + 3500) + 4),		# v8.2.1
    'IDM_DOCLIST_FILESCLOSE'                                     => ((40000 + 3500) + 1),		# v8.1.3
    'IDM_DOCLIST_FILESCLOSEOTHERS'                               => ((40000 + 3500) + 2),		# v8.1.3
    'IDM_DROPLIST_LIST'                                          => (14000 + 1),		# v8.4.3
    'IDM_DROPLIST_MRU_FIRST'                                     => (14000 + 20),		# v8.4.3
    'IDM_EDIT'                                                   => (40000 + 2000),
    ...
    #'IDM_EDIT_CLEARREADONLY'                                    => ((40000 + 2000) + 33),      # removed between npp v8.5.3 and v8.9.5
    'IDM_EDIT_CLEARREADONLYFORALLDOCS'                           => ((40000 + 2000) + 103),     # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_EDIT_COPY_ALL_NAMES'                                    => ((40000 + 2000) + 87),		# v8.2.1
    'IDM_EDIT_COPY_ALL_PATHS'                                    => ((40000 + 2000) + 88),		# v8.2.1
    ...
    'IDM_EDIT_FUNCCALLTIP_NEXT'                                  => (50000 + 11),		# v8.4.5
    'IDM_EDIT_FUNCCALLTIP_PREVIOUS'                              => (50000 + 10),		# v8.4.5
    'IDM_EDIT_INSERT_DATETIME_CUSTOMIZED'                        => ((40000 + 2000) + 86),	# v8.1.5
    'IDM_EDIT_INSERT_DATETIME_LONG'                              => ((40000 + 2000) + 85),	# v8.1.4
    'IDM_EDIT_INSERT_DATETIME_SHORT'                             => ((40000 + 2000) + 84),	# v8.1.4
    ...
    'IDM_EDIT_MULTISELECTALL'                                    => ((40000 + 2000) + 90),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTALLMATCHCASE'                           => ((40000 + 2000) + 91),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTALLMATCHCASEWHOLEWORD'                  => ((40000 + 2000) + 93),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTALLWHOLEWORD'                           => ((40000 + 2000) + 92),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTNEXT'                                   => ((40000 + 2000) + 94),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTNEXTMATCHCASE'                          => ((40000 + 2000) + 95),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTNEXTMATCHCASEWHOLEWORD'                 => ((40000 + 2000) + 97),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTNEXTWHOLEWORD'                          => ((40000 + 2000) + 96),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTSSKIP'                                  => ((40000 + 2000) + 99),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_MULTISELECTUNDO'                                   => ((40000 + 2000) + 98),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_OPENASFILE'                                        => ((40000 + 2000) + 73),      # name thru v8.9.6.2
    'IDM_EDIT_OPENINFOLDER'                                      => ((40000 + 2000) + 74),      # name thru v8.9.6.2
    'IDM_EDIT_OPENSELECTEDFILETOEDIT'                            => ((40000 + 2000) + 73),      # renamed in v8.9.6.4
    'IDM_EDIT_OPENSELECTEDFILEFOLDERINEXPLORER'                  => ((40000 + 2000) + 74),      # renamed in v8.9.6.4
    ...
    'IDM_EDIT_REDACT_SELECTION'                                  => ((40000 + 2000) + 106),     # updated between npp v8.5.3 and v8.9.5
    ...
    #IDM_EDIT_SETREADONLY'                                       => ((40000 + 2000) + 28),      # removed between npp v8.5.3 and v8.9.5
    'IDM_EDIT_SETREADONLYFORALLDOCS'                             => ((40000 + 2000) + 102),     # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_EDIT_SORTLINES_LENGTH_ASCENDING'                        => ((40000 + 2000) + 104),     # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_SORTLINES_LENGTH_DESCENDING'                       => ((40000 + 2000) + 105),     # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_EDIT_SORTLINES_LOCALE_ASCENDING'                        => ((40000 + 2000) + 100),     # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_SORTLINES_LOCALE_DESCENDING'                       => ((40000 + 2000) + 101),     # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_SORTLINES_RANDOMLY'                                => ((40000 + 2000) + 78), # added v7.9.1
    'IDM_EDIT_SORTLINES_REVERSE_ORDER'                           => ((40000 + 2000) + 83),	# v8.0
    ...
    'IDM_EDIT_TOGGLEREADONLY'                                    => ((40000 + 2000) + 28),      # updated between npp v8.5.3 and v8.9.5
    'IDM_EDIT_TOGGLESYSTEMREADONLY'                              => ((40000 + 2000) + 33),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_EXECUTE_VALIDATE_SHORTCUTSXML'                          => ((40000 + 9000) + 1),   # added v8.9.6.1
    'IDM_EXPORT_FUNC_LIST_AND_QUIT'                              => ((40000 + 4000) + 73),
    'IDM_FILE'                                                   => (40000 + 1000),
    'IDM_FILEMENU_EXISTCMDPOSITION'                              => 22,
    'IDM_FILEMENU_LASTONE'                                       => ((40000 + 1000) + 27),      # will always be the last in the FILE MENU (updated every time)
    'IDM_FILESWITCHER_FILESCLOSE'                                => ((40000 + 3500) + 1),	# renamed v8.1.3 to IDM_DOCLIST_*
    'IDM_FILESWITCHER_FILESCLOSEOTHERS'                          => ((40000 + 3500) + 2),	# renamed v8.1.3 to IDM_DOCLIST_*
    'IDM_FILE_CLOSE'                                             => ((40000 + 1000) + 3),
    'IDM_FILE_CLOSEALL'                                          => ((40000 + 1000) + 4),
    'IDM_FILE_CLOSEALL_BUT_CURRENT'                              => ((40000 + 1000) + 5),
    'IDM_FILE_CLOSEALL_BUT_PINNED'                               => ((40000 + 1000) + 26),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_FILE_OPEN_POWERSHELL'                                   => ((40000 + 1000) + 27),  # added v8.9.6.1
    ...
    'IDM_LANG_ERRORLIST'                                         => ((40000 + 6000) + 93),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_LANG_GDSCRIPT'                                          => ((40000 + 6000) + 87),      # updated between npp v8.5.3 and v8.9.5
    'IDM_LANG_GOLANG'                                            => ((40000 + 6000) + 89),      # updated between npp v8.5.3 and v8.9.5
    'IDM_LANG_GUI4CLI'                                           => ((40000 + 6000) + 52),
    'IDM_LANG_HASKELL'                                           => ((40000 + 6000) + 46),
    'IDM_LANG_HOLLYWOOD'                                         => ((40000 + 6000) + 88),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_LANG_JSON5'                                             => ((40000 + 6000) + 85),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_LANG_MSSQL'                                             => ((40000 + 6000) + 86),      # updated between npp v8.5.3 and v8.9.5
    'IDM_LANG_NIMROD'                                            => ((40000 + 6000) + 75),	# renamed v8.0
    'IDM_LANG_NIM'                                               => ((40000 + 6000) + 75),  # v8.0
    ...
    'IDM_LANG_RAKU'                                              => ((40000 + 6000) + 90),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_LANG_SAS'                                               => ((40000 + 6000) + 92),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_LANG_TOML'                                              => ((40000 + 6000) + 91),      # updated between npp v8.5.3 and v8.9.5
    'IDM_LANG_TXT2TAGS'                                          => ((40000 + 6000) + 82),
    'IDM_LANG_TYPESCRIPT'                                        => ((40000 + 6000) + 84),	# v8.1.4
    'IDM_LANG_UDLCOLLECTION_PROJECT_SITE'                        => ((40000 + 6000) + 301),	# v8.1.9.3
    ...
    #'IDM_ONLINESUPPORT'                                          => ((40000  + 7000)  + 11),	# removed v8.0; don't support even in previous versions because the service no longer exists
    'IDM_OPEN_ALL_RECENT_FILE'                                   => ((40000 + 2000) + 40),
    'IDM_PINTAB'                                                 => ((40000 + 4000) + 48),      # updated between npp v8.5.3 and v8.9.5
    'IDM_PROJECTPAGE'                                            => ((40000  + 7000)  + 2),
    'IDM_SEARCH'                                                 => (40000 + 3000),
    'IDM_SEARCH_ALLSTYLESTOCLIP'                                 => ((40000 + 3000) + 60), # v7.9.1
    'IDM_SEARCH_CHANGED_NEXT'                                    => ((40000 + 3000) + 67),      # updated between npp v8.5.3 and v8.9.5
    'IDM_SEARCH_CHANGED_PREV'                                    => ((40000 + 3000) + 68),      # updated between npp v8.5.3 and v8.9.5
    'IDM_SEARCH_CLEARALLMARKS'                                   => ((40000 + 3000) + 32),
    'IDM_SEARCH_CLEAR_BOOKMARKS'                                 => ((40000 + 3000) + 8),
    'IDM_SEARCH_CLEAR_CHANGE_HISTORY'                            => ((40000 + 3000) + 69),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_SEARCH_MARKONEEXT1'                                     => ((40000 + 3000) + 62),	# v8.0
    'IDM_SEARCH_MARKONEEXT2'                                     => ((40000 + 3000) + 63),	# v8.0
    'IDM_SEARCH_MARKONEEXT3'                                     => ((40000 + 3000) + 64),	# v8.0
    'IDM_SEARCH_MARKONEEXT4'                                     => ((40000 + 3000) + 65),	# v8.0
    'IDM_SEARCH_MARKONEEXT5'                                     => ((40000 + 3000) + 66),	# v8.0
    ...
    'IDM_SETTING_IMPORTSTYLETHEMES'                              => ((40000 + 8000) + 6),       # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_TOOL_SHA1_GENERATE'                                     => ((40000 + 8500) + 7),       # updated between npp v8.5.3 and v8.9.5
    'IDM_TOOL_SHA1_GENERATEFROMFILE'                             => ((40000 + 8500) + 8),       # updated between npp v8.5.3 and v8.9.5
    'IDM_TOOL_SHA1_GENERATEINTOCLIPBOARD'                        => ((40000 + 8500) + 9),       # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_TOOL_SHA512_GENERATE'                                   => ((40000 + 8500) + 10),      # updated between npp v8.5.3 and v8.9.5
    'IDM_TOOL_SHA512_GENERATEFROMFILE'                           => ((40000 + 8500) + 11),      # updated between npp v8.5.3 and v8.9.5
    'IDM_TOOL_SHA512_GENERATEINTOCLIPBOARD'                      => ((40000 + 8500) + 12),      # updated between npp v8.5.3 and v8.9.5
    ...
    #IDM_VIEW_CURLINE_HILITING'                                  => ((40000 + 4000) + 21),      # removed between npp v8.5.3 and v8.9.5
    'IDM_VIEW_DISTRACTIONFREE'                                   => ((40000 + 4000) + 11),	# v8.0
    'IDM_VIEW_DOCCHANGEMARGIN'                                   => ((40000 + 4000) + 45),	# removed v8.4.6
    'IDM_VIEW_DOCLIST'                                           => ((40000 + 4000) + 70),	# v8.1.3
    'IDM_VIEW_DOC_MAP'                                           => ((40000 + 4000) + 80),
    #IDM_VIEW_DRAWTABBAR_CLOSEBOTTUN'                            => ((40000 + 4000) + 38),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_DRAWTABBAR_DBCLK2CLOSE'                            => ((40000 + 4000) + 39),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_DRAWTABBAR_INACIVETAB'                             => ((40000 + 4000) + 8),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_DRAWTABBAR_MULTILINE'                              => ((40000 + 4000) + 44),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_DRAWTABBAR_TOPBAR'                                 => ((40000 + 4000) + 7),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_DRAWTABBAR_VERTICAL'                               => ((40000 + 4000) + 43),      # removed between npp v8.5.3 and v8.9.5
    ...
    'IDM_VIEW_FILESWITCHER_PANEL'                                => ((40000 + 4000) + 70),	# removed v8.1.3, but still supported in previous revs
    'IDM_VIEW_FOLD'                                              => ((40000 + 4000) + 50),
    'IDM_VIEW_FOLDALL'                                           => ((40000 + 4000) + 10), # v8.4.2
    #IDM_VIEW_FOLDERMAGIN'                                       => ((40000 + 4000) + 14),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_FOLDERMAGIN_ARROW'                                 => ((40000 + 4000) + 16),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_FOLDERMAGIN_BOX'                                   => ((40000 + 4000) + 18),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_FOLDERMAGIN_CIRCLE'                                => ((40000 + 4000) + 17),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_FOLDERMAGIN_SIMPLE'                                => ((40000 + 4000) + 15),      # removed between npp v8.5.3 and v8.9.5
    ...
    'IDM_VIEW_GOTO_END'                                          => 10006,                      # updated between npp v8.5.3 and v8.9.5
    'IDM_VIEW_GOTO_NEW_INSTANCE'                                 => 10003,
    'IDM_VIEW_GOTO_START'                                        => 10005,                      # updated between npp v8.5.3 and v8.9.5
    ...
    #IDM_VIEW_LINENUMBER'                                        => ((40000 + 4000) + 12),      # removed between npp v8.5.3 and v8.9.5
    'IDM_VIEW_LOAD_IN_NEW_INSTANCE'                              => 10004,
    #IDM_VIEW_LOCKTABBAR'                                        => ((40000 + 4000) + 6),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_LWALIGN'                                           => ((40000 + 4000) + 47),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_LWDEF'                                             => ((40000 + 4000) + 46),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_LWINDENT'                                          => ((40000 + 4000) + 48),      # removed between npp v8.5.3 and v8.9.5
    'IDM_VIEW_MONITORING'                                        => ((40000 + 4000) + 97),
    'IDM_VIEW_NPC'                                               => ((40000 + 4000) + 130),     # updated between npp v8.5.3 and v8.9.5
    'IDM_VIEW_NPC_CCUNIEOL'                                      => ((40000 + 4000) + 131),     # updated between npp v8.5.3 and v8.9.5
    ...
    #IDM_VIEW_REDUCETABBAR'                                      => ((40000 + 4000) + 5),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_REFRESHTABAR'                                      => ((40000 + 4000) + 40)       # removed between npp v8.5.3 and v8.9.5,
    'IDM_VIEW_SUMMARY'                                           => ((40000 + 4000) + 49),
    'IDM_VIEW_SWITCHTO_DOCLIST'                                  => ((40000 + 4000) + 109),	# v8.1.3
    ...
    #IDM_VIEW_SYMBOLMARGIN'                                      => ((40000 + 4000) + 13),      # removed between npp v8.5.3 and v8.9.5
    ...
    'IDM_VIEW_TAB_COLOUR_1'                                      => ((40000 + 4000) + 111),		# v8.4.6
    'IDM_VIEW_TAB_COLOUR_2'                                      => ((40000 + 4000) + 112),		# v8.4.6
    'IDM_VIEW_TAB_COLOUR_3'                                      => ((40000 + 4000) + 113),		# v8.4.6
    'IDM_VIEW_TAB_COLOUR_4'                                      => ((40000 + 4000) + 114),		# v8.4.6
    'IDM_VIEW_TAB_COLOUR_5'                                      => ((40000 + 4000) + 115),		# v8.4.6
    'IDM_VIEW_TAB_COLOUR_NONE'                                   => ((40000 + 4000) + 110),		# v8.4.6
    ...
    'IDM_VIEW_TOGGLE_FOLDALL'                                    => ((40000 + 4000) + 10), # removed v8.4.2
    'IDM_VIEW_TOGGLE_UNFOLDALL'                                  => ((40000 + 4000) + 29), # removed v8.4.2
    #IDM_VIEW_TOOLBAR_ENLARGE'                                   => ((40000 + 4000) + 3),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_TOOLBAR_ENLARGE_SET2'                              => ((40000 + 4000) + 28),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_TOOLBAR_REDUCE'                                    => ((40000 + 4000) + 2),       # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_TOOLBAR_REDUCE_SET2'                               => ((40000 + 4000) + 27),      # removed between npp v8.5.3 and v8.9.5
    #IDM_VIEW_TOOLBAR_STANDARD'                                  => ((40000 + 4000) + 4),       # removed between npp v8.5.3 and v8.9.5
    'IDM_VIEW_UNFOLD'                                            => ((40000 + 4000) + 60),
    'IDM_VIEW_UNFOLDALL'                                         => ((40000 + 4000) + 29),  # v8.4.2
    ...
    'IDM_VIEW_ZOOM_SYNC'                                         => ((40000 + 4000) + 27),      # updated between npp v8.5.3 and v8.9.5
    #IDM_WIKIFAQ'                                                => ((40000  + 7000)  + 7),     # removed between npp v8.5.3 and v8.9.5
    'IDM_WINDOW_COPY_NAME'                                       => ((11000 + 59) + 1),     # v8.3.2
    'IDM_WINDOW_COPY_PATH'                                       => ((11000 + 59) + 2),     # v8.3.2
    'IDM_WINDOW_MRU_FIRST'                                       => (11000 + 20),     # v8.3.2
    'IDM_WINDOW_MRU_LIMIT'                                       => (11000 + 59),     # v8.3.2, changed v8.4.3
    'IDM_WINDOW_SORT_FD_ASC'                                     => (11000 + 10),       # updated between npp v8.5.3 and v8.9.5
    'IDM_WINDOW_SORT_FD_DSC'                                     => (11000 + 11),       # updated between npp v8.5.3 and v8.9.5
    'IDM_WINDOW_SORT_FN_ASC'                                     => (11000 + 2),     # v8.3.2
    'IDM_WINDOW_SORT_FN_DSC'                                     => (11000 + 3),     # v8.3.2
    'IDM_WINDOW_SORT_FP_ASC'                                     => (11000 + 4),     # v8.3.2
    'IDM_WINDOW_SORT_FP_DSC'                                     => (11000 + 5),     # v8.3.2
    'IDM_WINDOW_SORT_FS_ASC'                                     => (11000 + 8),     # v8.3.2
    'IDM_WINDOW_SORT_FS_DSC'                                     => (11000 + 9),     # v8.3.2
    'IDM_WINDOW_SORT_FT_ASC'                                     => (11000 + 6),     # v8.3.2
    'IDM_WINDOW_SORT_FT_DSC'                                     => (11000 + 7),     # v8.3.2
    'IDM_WINDOW_WINDOWS'                                         => (11000 + 1),     # v8.3.2
    'IDR_DROPLIST_MENU'                                          => 14000,      # v8.4.3
    'IDR_WINDOWS_MENU'                                           => 11000,     # v8.3.2
);
