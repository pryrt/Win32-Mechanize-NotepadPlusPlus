# auto-converted from ./src/menuCmdID.h at Sun Sep  8 13:41:33 2019
...
our %nppidm = (
    ...
    'IDM_CLEAN_RECENT_FILE_LIST'                                 => ((IDM + 2000) + 41),
    ...
    'IDM_EXPORT_FUNC_LIST_AND_QUIT'                              => ((IDM + 4000) + 73),
    'IDM_FILEMENU_EXISTCMDPOSITION'                              => 22,
    'IDM_FILEMENU_LASTONE'                                       => (IDM_FILE + 24),
    'IDM_FILESWITCHER_FILESCLOSE'                                => ((IDM + 3500) + 1),
    'IDM_FILESWITCHER_FILESCLOSEOTHERS'                          => ((IDM + 3500) + 2),
    ...
    'IDM_FOCUS_ON_FOUND_RESULTS'                                 => ((IDM + 3000) + 45),
    'IDM_FORMAT_ANSI'                                            => ((40000 + 5000) + 4),
    'IDM_FORMAT_AS_UTF_8'                                        => ((40000 + 5000) + 8),
    'IDM_FORMAT_BIG5'                                            => ((IDM_FORMAT + 20) + 40),
    ...
    'IDM_FORMAT_DOS_437'                                         => ((IDM_FORMAT + 20) + 24),
    'IDM_FORMAT_DOS_720'                                         => ((IDM_FORMAT + 20) + 25),
    'IDM_FORMAT_DOS_737'                                         => ((IDM_FORMAT + 20) + 26),
    'IDM_FORMAT_DOS_775'                                         => ((IDM_FORMAT + 20) + 27),
    'IDM_FORMAT_DOS_850'                                         => ((IDM_FORMAT + 20) + 28),
    'IDM_FORMAT_DOS_852'                                         => ((IDM_FORMAT + 20) + 29),
    'IDM_FORMAT_DOS_855'                                         => ((IDM_FORMAT + 20) + 30),
    'IDM_FORMAT_DOS_857'                                         => ((IDM_FORMAT + 20) + 31),
    'IDM_FORMAT_DOS_858'                                         => ((IDM_FORMAT + 20) + 32),
    'IDM_FORMAT_DOS_860'                                         => ((IDM_FORMAT + 20) + 33),
    'IDM_FORMAT_DOS_861'                                         => ((IDM_FORMAT + 20) + 34),
    'IDM_FORMAT_DOS_862'                                         => ((IDM_FORMAT + 20) + 35),
    'IDM_FORMAT_DOS_863'                                         => ((IDM_FORMAT + 20) + 36),
    'IDM_FORMAT_DOS_865'                                         => ((IDM_FORMAT + 20) + 37),
    'IDM_FORMAT_DOS_866'                                         => ((IDM_FORMAT + 20) + 38),
    'IDM_FORMAT_DOS_869'                                         => ((IDM_FORMAT + 20) + 39),
    'IDM_FORMAT_ENCODE'                                          => ((40000 + 5000) + 20),
    'IDM_FORMAT_ENCODE_END'                                      => (IDM_FORMAT_ENCODE + 48),
