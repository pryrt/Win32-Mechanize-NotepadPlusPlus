# auto-converted from src/Notepad_plus_msgs.h at Mon Jun  8 12:15:43 2026
...
our %nppm_dummyhash = (
    ...
    'NPPM_ADDSCNMODIFIEDFLAGS'                                   => ((1024 + 1000) + 117),
    'NPPM_ADDTOOLBARICON_DEPRECATED'                             => ((1024 + 1000) + 41),
    'NPPM_ADDTOOLBARICON_FORDARKMODE'                            => ((1024 + 1000) + 101),
    'NPPM_ALLOCATECMDID'                                         => ((1024 + 1000) + 81),
    'NPPM_ALLOCATEINDICATOR'                                     => ((1024 + 1000) + 113),
    'NPPM_ALLOCATEMARKER'                                        => ((1024 + 1000) + 82),
    'NPPM_ALLOCATESUPPORTED_DEPRECATED'                          => ((1024 + 1000) + 80),
    'NPPM_CREATELEXER'                                           => ((1024 + 1000) + 110),
    'NPPM_CREATESCINTILLAHANDLE'                                 => ((1024 + 1000) + 20),
    'NPPM_DARKMODESUBCLASSANDTHEME'                              => ((1024 + 1000) + 112),
    'NPPM_DECODESCI'                                             => ((1024 + 1000) + 27),
    'NPPM_DESTROYSCINTILLAHANDLE_DEPRECATED'                     => ((1024 + 1000) + 21),
    ...
    'NPPM_DOCLISTDISABLEEXTCOLUMN'                               => ((1024 + 1000) + 89),
    'NPPM_DOCLISTDISABLEPATHCOLUMN'                              => ((1024 + 1000) + 102),
    ...
    'NPPM_GETCURRENTMACROSTATUS'                                 => ((1024 + 1000) + 106),
    ...
    'NPPM_GETDARKMODECOLORS'                                     => ((1024 + 1000) + 108),
    'NPPM_GETEDITORDEFAULTBACKGROUNDCOLOR'                       => ((1024 + 1000) + 91),
    'NPPM_GETEDITORDEFAULTFOREGROUNDCOLOR'                       => ((1024 + 1000) + 90),
    'NPPM_GETENABLETHEMETEXTUREFUNC_DEPRECATED'                  => ((1024 + 1000) + 45),
    'NPPM_GETEXTERNALLEXERAUTOINDENTMODE'                        => ((1024 + 1000) + 103),
    ...
    'NPPM_GETNATIVELANGFILENAME'                                 => ((1024 + 1000) + 116),
    ...
    'NPPM_GETNPPSETTINGSDIRPATH'                                 => ((1024 + 1000) + 119),
    'NPPM_GETNPPVERSION'                                         => ((1024 + 1000) + 50),
    'NPPM_GETOPENFILENAMESPRIMARY_DEPRECATED'                    => ((1024 + 1000) + 17),
    'NPPM_GETOPENFILENAMESSECOND_DEPRECATED'                     => ((1024 + 1000) + 18),
    'NPPM_GETOPENFILENAMES_DEPRECATED'                           => ((1024 + 1000) + 8),
    ...
    'NPPM_GETTABCOLORID'                                         => ((1024 + 1000) + 114),
    'NPPM_GETTOOLBARICONSETCHOICE'                               => ((1024 + 1000) + 118),
    ...
    'NPPM_ISDARKMODEENABLED'                                     => ((1024 + 1000) + 107),
    'NPPM_ISDOCLISTSHOWN'                                        => ((1024 + 1000) + 86),
    ...
    'NPPM_SETEXTERNALLEXERAUTOINDENTMODE'                        => ((1024 + 1000) + 104),
    ...
    'NPPM_SETUNTITLEDNAME'                                       => ((1024 + 1000) + 115),
    'NPPM_SHOWDOCLIST'                                           => ((1024 + 1000) + 85),
    ...
    'NPPN_CMDLINEPLUGINMSG'                                      => (1000 + 28),
    'NPPN_DARKMODECHANGED'                                       => (1000 + 27),
    'NPPN_DOCORDERCHANGED'                                       => (1000 + 17),
    'NPPN_EXTERNALLEXERBUFFER'                                   => (1000 + 29),
    ...
    'NPPN_FIRST'                                                 => 1000,
    'NPPN_GLOBALMODIFIED'                                        => (1000 + 30),
    'NPPN_LANGCHANGED'                                           => (1000 + 11),
    'NPPN_NATIVELANGCHANGED'                                     => (1000 + 31),
    ...
    'NPPN_TOOLBARICONSETCHANGED'                                 => (1000 + 32),
