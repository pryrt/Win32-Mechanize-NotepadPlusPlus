# auto-converted from src/menuCmdID.h at Sun May 17 13:59:23 2026
...
#   'IDM_EDIT_CLEARREADONLY'                                     => ((40000 + 2000) + 33),      # updated between npp v8.5.3 and v8.9.5
    ...
    #IDM_EDIT_SETREADONLY'                                       => ((40000 + 2000) + 28),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_FILEMENU_LASTONE'                                       => ((40000 + 1000) + 26),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_FILE_OPENFOLDERASWORKSPACE'                             => ((40000 + 1000) + 22),
...
#   'IDM_VIEW_CURLINE_HILITING'                                  => ((40000 + 4000) + 21),      # updated between npp v8.5.3 and v8.9.5
    'IDM_VIEW_DISTRACTIONFREE'                                   => ((40000 + 4000) + 11),
    'IDM_VIEW_DOCLIST'                                           => ((40000 + 4000) + 70),
    'IDM_VIEW_DOC_MAP'                                           => ((40000 + 4000) + 80),
#   'IDM_VIEW_DRAWTABBAR_CLOSEBOTTUN'                            => ((40000 + 4000) + 38),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_DRAWTABBAR_DBCLK2CLOSE'                            => ((40000 + 4000) + 39),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_DRAWTABBAR_INACIVETAB'                             => ((40000 + 4000) + 8),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_DRAWTABBAR_MULTILINE'                              => ((40000 + 4000) + 44),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_DRAWTABBAR_TOPBAR'                                 => ((40000 + 4000) + 7),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_DRAWTABBAR_VERTICAL'                               => ((40000 + 4000) + 43),      # updated between npp v8.5.3 and v8.9.5
    'IDM_VIEW_EOL'                                               => ((40000 + 4000) + 26),
    'IDM_VIEW_FILEBROWSER'                                       => ((40000 + 4000) + 85),
    'IDM_VIEW_FOLD'                                              => ((40000 + 4000) + 50),
    'IDM_VIEW_FOLDALL'                                           => ((40000 + 4000) + 10),
#   'IDM_VIEW_FOLDERMAGIN'                                       => ((40000 + 4000) + 14),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_FOLDERMAGIN_ARROW'                                 => ((40000 + 4000) + 16),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_FOLDERMAGIN_BOX'                                   => ((40000 + 4000) + 18),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_FOLDERMAGIN_CIRCLE'                                => ((40000 + 4000) + 17),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_FOLDERMAGIN_SIMPLE'                                => ((40000 + 4000) + 15),      # updated between npp v8.5.3 and v8.9.5
...
#   'IDM_VIEW_LINENUMBER'                                        => ((40000 + 4000) + 12),      # updated between npp v8.5.3 and v8.9.5
    'IDM_VIEW_LOAD_IN_NEW_INSTANCE'                              => 10004,
#   'IDM_VIEW_LOCKTABBAR'                                        => ((40000 + 4000) + 6),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_LWALIGN'                                           => ((40000 + 4000) + 47),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_LWDEF'                                             => ((40000 + 4000) + 46),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_LWINDENT'                                          => ((40000 + 4000) + 48),      # updated between npp v8.5.3 and v8.9.5
...
#   'IDM_VIEW_REDUCETABBAR'                                      => ((40000 + 4000) + 5),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_REFRESHTABAR'                                      => ((40000 + 4000) + 40),      # updated between npp v8.5.3 and v8.9.5
...
#   'IDM_VIEW_SYMBOLMARGIN'                                      => ((40000 + 4000) + 13),      # updated between npp v8.5.3 and v8.9.5
    ...
    'IDM_VIEW_TAB_END'                                           => ((40000 + 4000) + 117),
    ...
    'IDM_VIEW_TAB_START'                                         => ((40000 + 4000) + 116),
#   'IDM_VIEW_TOOLBAR_ENLARGE'                                   => ((40000 + 4000) + 3),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_TOOLBAR_ENLARGE_SET2'                              => ((40000 + 4000) + 28),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_TOOLBAR_REDUCE'                                    => ((40000 + 4000) + 2),       # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_TOOLBAR_REDUCE_SET2'                               => ((40000 + 4000) + 27),      # updated between npp v8.5.3 and v8.9.5
#   'IDM_VIEW_TOOLBAR_STANDARD'                                  => ((40000 + 4000) + 4),       # updated between npp v8.5.3 and v8.9.5
...
#   'IDM_WIKIFAQ'                                                => ((40000  + 7000)  + 7),     # updated between npp v8.5.3 and v8.9.5
