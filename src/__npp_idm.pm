...
our %nppidm_dummyhash = (
    ...
    'IDM_EDIT_BEGINENDSELECT_COLUMNMODE'                         => ((40000 + 2000) + 89),
    ...
    'IDM_EDIT_CLEARREADONLYFORALLDOCS'                           => ((40000 + 2000) + 103),
    ...
    'IDM_EDIT_MULTISELECTALL'                                    => ((40000 + 2000) + 90),
    'IDM_EDIT_MULTISELECTALLMATCHCASE'                           => ((40000 + 2000) + 91),
    'IDM_EDIT_MULTISELECTALLMATCHCASEWHOLEWORD'                  => ((40000 + 2000) + 93),
    'IDM_EDIT_MULTISELECTALLWHOLEWORD'                           => ((40000 + 2000) + 92),
    'IDM_EDIT_MULTISELECTNEXT'                                   => ((40000 + 2000) + 94),
    'IDM_EDIT_MULTISELECTNEXTMATCHCASE'                          => ((40000 + 2000) + 95),
    'IDM_EDIT_MULTISELECTNEXTMATCHCASEWHOLEWORD'                 => ((40000 + 2000) + 97),
    ...
    'IDM_EDIT_REDACT_SELECTION'                                  => ((40000 + 2000) + 106),
    ...
    'IDM_EDIT_SETREADONLYFORALLDOCS'                             => ((40000 + 2000) + 102),
    ...
    'IDM_EDIT_SORTLINES_LENGTH_ASCENDING'                        => ((40000 + 2000) + 104),
    'IDM_EDIT_SORTLINES_LENGTH_DESCENDING'                       => ((40000 + 2000) + 105),
    ...
    'IDM_EDIT_SORTLINES_LOCALE_ASCENDING'                        => ((40000 + 2000) + 100),
    'IDM_EDIT_SORTLINES_LOCALE_DESCENDING'                       => ((40000 + 2000) + 101),
    ...
    'IDM_EDIT_TOGGLEREADONLY'                                    => ((40000 + 2000) + 28),
    'IDM_EDIT_TOGGLESYSTEMREADONLY'                              => ((40000 + 2000) + 33),
    ...
    'IDM_FILE_OPEN_POWERSHELL'                                   => ((40000 + 1000) + 27),
    ...
    'IDM_LANG_ERRORLIST'                                         => ((40000 + 6000) + 93),
    ...
    'IDM_LANG_GDSCRIPT'                                          => ((40000 + 6000) + 87),
    'IDM_LANG_GOLANG'                                            => ((40000 + 6000) + 89),
    'IDM_LANG_GUI4CLI'                                           => ((40000 + 6000) + 52),
    'IDM_LANG_HASKELL'                                           => ((40000 + 6000) + 46),
    'IDM_LANG_HOLLYWOOD'                                         => ((40000 + 6000) + 88),
    ...
    'IDM_SETTING_IMPORTSTYLETHEMES'                              => ((40000 + 8000) + 6),
    ...
    'IDM_TOOL_SHA1_GENERATE'                                     => ((40000 + 8500) + 7),
    'IDM_TOOL_SHA1_GENERATEFROMFILE'                             => ((40000 + 8500) + 8),
    'IDM_TOOL_SHA1_GENERATEINTOCLIPBOARD'                        => ((40000 + 8500) + 9),
    ...
    'IDM_TOOL_SHA512_GENERATE'                                   => ((40000 + 8500) + 10),
    'IDM_TOOL_SHA512_GENERATEFROMFILE'                           => ((40000 + 8500) + 11),
    'IDM_TOOL_SHA512_GENERATEINTOCLIPBOARD'                      => ((40000 + 8500) + 12),
    ...
    'IDM_VIEW_NPC'                                               => ((40000 + 4000) + 130),
    'IDM_VIEW_NPC_CCUNIEOL'                                      => ((40000 + 4000) + 131),
